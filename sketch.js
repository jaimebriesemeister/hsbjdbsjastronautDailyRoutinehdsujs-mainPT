...
function draw() {
  ...
  textSize(20);
  fill("white")
  text("Instruções:",20, 35);
  textSize(15);
  text("Seta para Cima = Escovar os Dentes",20, 55);
  text("Seta para Baixo = Fazer Exercícios",20, 70);
  text("Seta para Esquerda = Comer",20, 85);
  text("Seta para Direita = Tomar Banho",20, 100);
  text("Tecla m = Mover-se",20, 115);
